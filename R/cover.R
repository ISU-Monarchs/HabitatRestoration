...
#'
#' This data set contains daubenmire land cover %'s observed at 10m intervals inside a 0.5m square along a transect.
#'
...
#' 
#' **class** Daubenmire coverage classes:
#' *0	  None
#' *1	  Trace
#' *3	  1-5%
#' *16	5-25%
...
#' 
#' ‘litter depth’: Depth of horizontal dead plant material on the soil surface in cm. Value is not a %.
#' 
#' 2016
#' 
