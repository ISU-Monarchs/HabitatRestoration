...
#'   \item currently_flowering_plants: factor, daubenmire style land cover of currently flowering plants in defined area surrounding plot. Grouped by percentages: 0,0-5,5-25,25-50,50-75,75-100
#'   \item dominant_flowering_species: character, dominant flowering plant species in defined area surrounding plot
#'   \item milkweed_ramet: integer, count of milkweed ramets in defined area surrounding plot
#'   \item sky: character, cloud cover group name(clear, mostly clear, mostly cloudy, cloudy, rain)
#'   \item temperature: numeric, temperature in degrees Fahrenheit
#'   \item wind: numeric, wind speed in miles per hour
#' }
