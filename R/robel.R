...
#' 
#' ‘direction’: Denotes the cardinal direction from which the data was taken.
#' 
#' ‘n’, ‘e’, ‘s’, ‘w’: Denotes the cardinal direction from which the data was taken. Directions are based on the observer’s position in relation to the pole, not the direction in which the observer is looking. Example: ‘n’ data is taken by the observer when the observer is north of the pole looking south.
#' 
#' 
